  ...
  const navLinks = (
    <>
      <NavLink
        className={({ isActive }) =>
          isActive
            ? "text-[#FA7436] font-medium md:border-b-2 border-[#FA7436] "
            : "hover:text-[#FA7436]"
        }
        to="/"
      >
      ...
      <div className="navbar-start">
        ...
        <Link to="/" className="btn btn-ghost text-xl md:text-2xl lg:text-3xl">
          <span className="text-black">
            <span className="text-[#FA7436]">Tropi</span>Tour
          </span>
        </Link>
      </div>
      ...
      <div className="navbar-end ">
        ...
        {loading ? (
          ...
          <div className="dropdown dropdown-end relative">
            ...
            <ul
              tabIndex={0}
              className={`menu menu-sm dropdown-content mt-3 z-[10] p-2 shadow bg-base-100 rounded-box w-40 md:w-60 lg:w-60 absolute top-full  ${
                isOpen ? "" : "hidden"
              }`}
            >
              <div className="flex flex-col lg:flex-row md:flex-row  items-center md:gap-3 lg:gap-3 md:pb-8 lg:pb-8">
                ...
                <div>
                  <h3 className="md:text-[18px] lg:text-[18px] font-medium   w-full ">
              ...
              <li className="text-[17px] border-t-2 border-[#0000000d] ">
                <Link
                  ...
                  className="btn  bg-[#FA7436] text-white"
                >
                  {" "}
                  Sign Out
                </Link>
          ...
          <Link to="/login" className="btn  bg-[#FA7436] text-white">
            {" "}
            Sign In
          </Link>
        )}
