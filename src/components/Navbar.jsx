...
const Navbar = () => {
  ...
  <input   checked={theme === 'dark'} type="checkbox"  onChange={handleTheme}  className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2 "/>
...
{loading ? <div><span className="loading loading-ring loading-lg"></span></div> :
