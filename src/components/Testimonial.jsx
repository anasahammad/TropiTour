...
<div>
  ...
  <input type="radio" name="rating-2" className="mask mask-star-2 h-4 bg-orange-400" />
	...
	<div className="container p-4 mx-auto text-center">
		<h2 className="text-3xl md:text-4xl lg:text-4xl ligth:text-[#222] font-bold dark:text-white"><span className="text-[#FA7436]">Trusted by</span> the industry leaders </h2>
	</div>
